...
interface ITabSwitch extends IMessage {type: typeof MESSAGE.TAB_SWITCH; id: number; }
...
interface ITabNew extends IMessage {type: typeof MESSAGE.TAB_NEW; url: string; }
interface IZoom extends IMessage {type: typeof MESSAGE.ZOOM; zoomType: EZoomType; }
...
interface IShowFavorites extends IMessage {type: typeof MESSAGE.SHOW_FAVORITES; favorites: chrome.topSites.MostVisitedURL; }
interface IShowTabs extends IMessage {type: typeof MESSAGE.SHOW_TABS; }
